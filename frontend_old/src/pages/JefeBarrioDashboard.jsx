// src/pages/JefeBarrioDashboard.jsx
  ...
  useEffect(() => {
    ...
    const fetchPerfil = async () => {
      try {
        ...
        if (data.user.role !== "JEFE_BARRIO") {
          throw new Error("Este panel es solo para JEFES DE BARRIO.");
        }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-semibold mb-2">Panel Jefe de Barrio</h1>
        <p className="text-slate-300 text-sm mb-4">
          Aquí verás el estado general de las viviendas de tu barrio (próximamente).
        </p>
      </main>
    </div>
  );
