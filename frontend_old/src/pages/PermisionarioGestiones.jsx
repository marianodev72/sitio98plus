        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#0b1020] border border-slate-700/60 rounded-2xl p-6 flex flex-col justify-between">
            ...
            <div className="mt-6 flex gap-3">
              <button
                onClick={() => navigate("/permisionario/gestiones/anexo11/nuevo")}
          ...
          <div className="bg-[#0b1020] border border-slate-700/60 rounded-2xl p-6 flex flex-col justify-between">
            ...
            <div className="mt-6 flex gap-3">
              <button
                onClick={() => navigate("/permisionario/gestiones/anexo4/nuevo")}
                className="px-6 py-2 rounded-full bg-sky-500 hover:bg-sky-400 text-sm font-semibold transition-colors"
              >
                Iniciar Anexo 4
              </button>
          ...
          {/* ANEXO 7 */}
          <div className="bg-[#0b1020] border border-slate-700/60 rounded-2xl p-6 flex flex-col justify-between">
            <h2 className="text-xl font-semibold mb-2">Ampliación de novedades (Anexo 7)</h2>
            <p className="text-slate-300 text-sm">
              Declaración que ampliás vos para informar novedades adicionales sobre la toma de vivienda.
            </p>
            <div className="mt-6 flex gap-3">
              <button
