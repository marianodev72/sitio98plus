        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          <div>
            ...
            <p className="text-slate-300 max-w-3xl">
              Bienvenido, Carlos Allievi. Desde este panel vas a poder gestionar
              tu vivienda fiscal, tus comunicaciones y tus trámites como
              permisionario.
            </p>
          </div>
          ...
          <button
            ...
            className="self-start md:self-auto px-4 py-2 rounded-full bg-red-600 hover:bg-red-500 text-sm font-semibold transition-colors"
          >
            Cerrar sesión
          </button>
        </div>
