...
import BasesMaestras from "../pages/admin_general/BasesMaestras";
...
import MisComunicacionesInspectorAlojamientos from "../pages/alojamientos_inspector/MisComunicaciones";
  ...
  <Route path="*" element={<GenericUnavailable />} />
        ...
        <Route path="permisionario" element={<PermisionarioLayout />}>
          ...
          <Route path="alojamientos-inspector" element={<AlojamientosInspectorLayout />}>
            ...
            <Route path="comunicaciones" element={<MisComunicacionesInspectorAlojamientos />} />
            <Route path="*" element={<GenericUnavailable />} />
          </Route>
