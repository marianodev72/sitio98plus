// src/pages/AlojadoDashboard.jsx
  ...
  useEffect(() => {
    ...
    const fetchPerfil = async () => {
      try {
        ...
        if (data.user.role !== "ALOJADO") {
          throw new Error("Este panel es solo para ALOJADOS.");
        }
    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-8">
        ...
        <p className="text-slate-300 text-sm mb-4">
          Bienvenido, {user.nombre} {user.apellido}. Aquí verás la información de tu alojamiento (próximamente).
        </p>
      </main>
    </div>
  );
