...
router.patch("/anexo-24/:id", anexo24Controller.actualizarDatos);
router.post("/anexo-24/:id/enviar", anexo24Controller.enviar);
...
router.post("/:id/generar-anexo-24", anexo24Controller.generarDesdeAnexo23);
